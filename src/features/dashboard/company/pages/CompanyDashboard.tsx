          ...
          <motion.div key="marketplace" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-6">
            ...
            <div className="dashboard-card overflow-hidden">
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/30">
                    <TableHead className="text-left px-4 py-5 text-xs uppercase font-black tracking-widest">Produce</TableHead>
                    ...
                    <TableHead className="text-center px-4 text-xs uppercase font-black tracking-widest">Avail. Qty</TableHead>
                    <TableHead className="text-center px-4 text-xs uppercase font-black tracking-widest">Min Order</TableHead>
                    <TableHead className="text-center px-4 text-xs uppercase font-black tracking-widest">Unit Price</TableHead>
                ...
                <TableBody>
                  {isErrorListings ? (
                    <TableRow>
                      <TableCell colSpan={7} className="py-8 text-center text-destructive font-bold break-words px-4">
                    ...
                    <TableRow>
                      <TableCell colSpan={7} className="py-8 text-center text-muted-foreground">Loading marketplace listings...</TableCell>
                    </TableRow>
                  ) : filteredFarmerListings.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={7} className="py-8 text-center text-muted-foreground">No listings found.</TableCell>
                    </TableRow>
                    ...
                    >
                      <TableCell className="py-5 px-4 text-left">
                        <div className="flex items-center gap-3">
                      ...
                      <TableCell className="py-5 px-4 text-left text-[13px] font-bold text-foreground/80">{fl.farmer}</TableCell>
                      <TableCell className="py-5 px-4 text-left text-xs text-muted-foreground leading-tight max-w-[140px] truncate">{fl.location}</TableCell>
                      <TableCell className="py-5 px-4 text-center text-sm font-black text-foreground">{fl.qty}</TableCell>
                      <TableCell className="py-5 px-4 text-center">
                        <span className="text-[11px] font-bold text-amber-500 bg-amber-500/10 px-2.5 py-1 rounded-md border border-amber-500/20">{fl.minOrder}</span>
                      </TableCell>
                      <TableCell className="py-5 px-4 text-center text-[15px] font-black text-primary tracking-tight">{fl.price}</TableCell>
                      <TableCell className="py-5 px-4 text-center text-[11px] text-muted-foreground font-medium">{fl.createdAt}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
